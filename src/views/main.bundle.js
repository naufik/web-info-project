...
module.exports = "<body>\r\n<style>\r\n  @import url('https://fonts.googleapis.com/css?family='Libre+Baskerville|Libre+Franklin');\r\n</style>\r\n\r\n<app-logged-header></app-logged-header>\r\n<br>\r\n\r\n<div class=\"main\">\r\n  <div class=\"tit\">\r\n    <div class=\"titlename\">\r\n      WHAT'S IN MY FRIDGE  <a (click)=\"toggleAdd()\" class=\"\"><i class=\"fas fa-edit section-icon\"></i></a>\r\n    </div>\r\n\r\n    <div class=\"btn-group\">\r\n      Sorting\r\n      <button type=\"button\" class=\"btn btn-sm btn-secondary dropdown-toggle dropdown-toggle-split\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\r\n        <span class=\"sr-only\">Toggle Dropdown</span>\r\n      </button>\r\n      <ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu1\">\r\n        <h6 class=\"dropdown-header\">When Added</h6>\r\n        <li class=\"dropdown-item\">Oldest First</li>\r\n        <li class=\"dropdown-item\">Newest First</li>\r\n        <div class=\"dropdown-divider\"></div>\r\n        <h6 class=\"dropdown-header\">Expiry</h6>\r\n        <li class=\"dropdown-item\" (click)=\"sortFridge(compareByExpiry)\">Ascending</li>\r\n        <li class=\"dropdown-item\" (click)=\"sortFridge(compareByExpiry, true)\">Descending</li>\r\n        <div class=\"dropdown-divider\"></div>\r\n        <li class=\"dropdown-item\" (click)=\"sortFridge(compareByAlpha)\">Alphabetic</li>\r\n      </ul>\r\n    </div>\r\n\r\n    <div class=\"btn-group2\">\r\n      Show\r\n      <button type=\"button\" class=\"btn btn-sm btn-secondary dropdown-toggle dropdown-toggle-split\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\r\n        <span class=\"sr-only\">Toggle Dropdown</span>\r\n      </button>\r\n      <ul class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu1\">\r\n        <h6 class=\"dropdown-header\">Expired In</h6>\r\n        <li class=\"dropdown-item\">Day</li>\r\n        <li class=\"dropdown-item\">Week</li>\r\n        <div class=\"dropdown-divider\"></div>\r\n        <li class=\"dropdown-item\">Food</li>\r\n        <li class=\"dropdown-item\">Drink</li>\r\n\r\n      </ul>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"main\">\r\n  <hr>\r\n</div>\r\n\r\n<div class=\"main\">\r\n  <div class=\"search\">\r\n    <add-recipe (submit)=\"addNew($event)\" *ngIf=\"add\"></add-recipe>\r\n  </div>\r\n</div>\r\n\r\n<div class=\"main2\" *ngFor=\"let item of data\">\r\n  <app-fridgeitem (save)=\"onItemChanged()\" [itemsrc]=\"item\"></app-fridgeitem>\r\n</div>\r\n\r\n</body>\r\n"
...
var FridgeComponent = /** @class */ (function () {
    ...
    FridgeComponent.prototype.saveAll = function (refresh) {
        var _this = this;
    ...
    FridgeComponent.prototype.onItemChanged = function () {
        var _this = this;
    ...
    FridgeComponent.prototype.sortFridge = function (compare, reverse) {
        if (reverse === void 0) { reverse = false; }
        this.data.sort(reverse ? function (a, b) { return compare(b, a); } : compare);
    };
    FridgeComponent.prototype.compareByExpiry = function (a, b) {
        return __WEBPACK_IMPORTED_MODULE_2_moment__(a.expiry).diff(__WEBPACK_IMPORTED_MODULE_2_moment__(b.expiry), 'days');
    };
    FridgeComponent.prototype.compareByAlpha = function (a, b) {
        if (a.name > b.name) {
            return 1;
        }
        if (a.name === b.name) {
...
module.exports = "<div class=\"page\">\r\n  <div class=\"section-header\">\r\n    <a (click)=\"collapseItem()\">{{ itemsrc.name }}</a>\r\n  </div>\r\n  <div class=\"main\">\r\n    <div class=\"contents\" *ngIf=\"!collapsed\">\r\n      <form class=\"needs-validation\" novalidate>\r\n        <div class=\"form-row\">\r\n          <div class=\"col\" >\r\n            <label for=\"DaysLeft\" class=\"col-form-label-sm\">Days Left</label>\r\n            <input class=\"form-control form-control-sm\" (change)=\"setDate(daysLeftBox.value)\" id=\"DaysLeft\" [(ngModel)]=\"daysLeft\" name=\"daysLeftBox\" #daysLeftBox>\r\n          </div>\r\n          <div class=\"col\">\r\n            <label for=\"ExpiryDate\" class=\"col-form-label-sm\">Expiry Date</label>\r\n            <input class=\"form-control form-control-sm\" (change)=\"onChange(dateBox.value)\" id=\"ExpiryDate\" [(ngModel)]=\"dateString\" name=\"dateBox\" #dateBox>\r\n          </div>\r\n\r\n          <div class=\"col\">\r\n            <label for=\"AmountLeft\" class=\"col-form-label-sm\">Amount Left</label>\r\n            <input class=\"form-control form-control-sm\" (change)=\"onChange(qtyBox.value)\" id=\"AmountLeft\" [(ngModel)]=\"shownQty\" type=\"number\" name=\"qtyBox\" #qtyBox>\r\n          </div>\r\n        </div>\r\n        <br>\r\n        <select class=\"custom-select custom-select-sm\">\r\n          <option selected>Food</option>\r\n          <option value=\"1\">Drink</option>\r\n        </select>\r\n      </form>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
var FridgeitemComponent = /** @class */ (function () {
    ...
    FridgeitemComponent.prototype.getDateDisplay = function () {
        return __WEBPACK_IMPORTED_MODULE_1_moment__(this.itemsrc.expiry).format("DD/MM/YYYY");
    };
    FridgeitemComponent.prototype.onChange = function (newStr) {
        this.itemsrc.qty = parseInt(this.shownQty);
        try {
            var date = __WEBPACK_IMPORTED_MODULE_1_moment__(this.dateString, "DD/MM/YYYY");
            date.set('hour', 0);
            date.set('minute', 0);
    ...
    FridgeitemComponent.prototype.getDaysLeft = function () {
        return __WEBPACK_IMPORTED_MODULE_1_moment__(this.itemsrc.expiry).diff(__WEBPACK_IMPORTED_MODULE_1_moment__(), 'days');
    };
    FridgeitemComponent.prototype.setDate = function (daysLeft) {
        this.itemsrc.expiry = __WEBPACK_IMPORTED_MODULE_1_moment__().add(parseInt(daysLeft), 'days').toDate();
        this.dateString = this.getDateDisplay();
        this.save.emit();
    };
    __decorate([
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["P" /* Output */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */])
    ], FridgeitemComponent.prototype, "save", void 0);
...
var ListcontainerComponent = /** @class */ (function () {
    ...
    ListcontainerComponent.prototype.getUrl = function (item) {
    ...
    ListcontainerComponent.prototype.getPostAnnotation = function (item) {
        if (!item.qty) {
            return undefined;
        }
        else {
            return __WEBPACK_IMPORTED_MODULE_2_moment__(item.expiry).diff(__WEBPACK_IMPORTED_MODULE_2_moment__(), 'days').toString() + " days";
        }
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
...
module.exports = "<div class=\"list-base\">\r\n  <div class=\"grocerymodule\">\r\n    <a *ngIf=\"destination\" [routerLink]=\"['/' + destination]\">\r\n      <img class=\"img\" src=\"assets/grocery.jpg\">\r\n    </a>\r\n    <img *ngIf=\"destination === undefined\" class=\"img\" src=\"assets/grocery.jpg\">\r\n  </div>\r\n  <hr>\r\n  <p>{{ getDisplayText() }}</p>\r\n</div>\r\n"
...
var ListitemComponent = /** @class */ (function () {
    ...
    ListitemComponent.prototype.getDisplayText = function () {
        var display = this.listname;
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], ListitemComponent.prototype, "postAnnotation", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
...
module.exports = "<app-logged-header></app-logged-header>\r\n\r\n<div class=\"container-fluid bod\">\r\n  <div class=\"row\">\r\n    <div class=\"col-lg-3\">\r\n    </div>\r\n    <div class=\"col-lg-6 content1\">\r\n          <app-listcontainer [title]=\"'FRIDGE'\" [destination]=\"'fridge'\" [datasource]=\"fridge\" #lcf></app-listcontainer>\r\n          <app-listcontainer [title]=\"'MY LISTS'\" [destination]=\"'lists'\" [datasource]=\"lists\" #lcl></app-listcontainer>\r\n    </div>\r\n    <div class=\"col-lg-3\">\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
var MainpageComponent = /** @class */ (function () {
    ...
    MainpageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataretriver.getListsForUser(this.email).then(function (data) {
            _this.lists = data.slice(0, 3);
        });
        this.dataretriver.getUserData(this.email).then(function (data) {
            _this.fridge = data.fridge.slice(0, 3);
        });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], MainpageComponent.prototype, "email", void 0);
